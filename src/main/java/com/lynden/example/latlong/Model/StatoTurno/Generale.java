...
public class Generale implements State_Turno {
	...
	@Override
	public ArrayList<com.lynden.example.latlong.Giocatore> InizioTurno(ArrayList<Giocatore> g, String NomeMappa, Turno t, Stato_Giocatore gioca) throws FileNotFoundException,IOException {
